...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,594 | 🐛 106 | 📅 2026-09-02
...
* [BitFun](https://github.com/GCWing/BitFun) ⭐ 2,081 | 🐛 80 | 🌐 Rust | 📅 2026-09-06 - Open-source cross-platform desktop AI agent that plans, edits, tests, and commits in real Git repositories, while also handling browser, terminal, desktop-app, and remote-workspace tasks through MCP, Skills, Hooks, and task-specific Mini Apps.
* [Agent Teams](https://github.com/777genius/agent-teams-ai) ⭐ 2,076 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-06 - Open-source desktop app for autonomous AI coding teams across Claude, Codex, and OpenCode. Give high-level commands while agents handle Kanban tasks, messaging, code review, logs, and approvals across 200+ models and 75+ LLM providers.
* [Orkas](https://orkas.ai?source=gh_vibe) - Open-source, local-first desktop workspace that coordinates specialist agents and runs Claude Code, Codex, OpenCode, and Cline from one chat. [Source](https://github.com/Orkas-AI/Orkas) ⭐ 1,761 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-06
* [Parallel Code](https://github.com/johannesjo/parallel-code) ⭐ 1,003 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-04 - Open-source desktop app for running Claude Code, Codex CLI, Gemini CLI, and other terminal coding agents in parallel, with isolated git worktrees, terminal panes, diff review, and merge controls.
* [Superagent](https://github.com/pungme/superagent-desktop) ⭐ 26 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-04 - Open-source macOS desktop app that gives Claude Code and Codex a real browser to navigate and drive, an iOS Simulator to install and screenshot apps in, and a phone companion app for remote monitoring.
* [DevProjex](https://github.com/Avazbek22/DevProjex) ⭐ 21 | 🐛 13 | 🌐 C# | 📅 2026-09-06 - Local-first cross-platform codebase-context workspace with GUI, TUI, CLI, and a read-only MCP server for selecting, previewing, redacting, compressing, and packing project context.
...
* [avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 18,152 | 🐛 44 | 🌐 Lua | 📅 2026-09-06 - Neovim plugin designed to emulate the behavior of the Cursor AI IDE. It provides AI-driven code suggestions and allows you to apply recommendations directly to your source files with minimal effort.
...
* [anthropics/claude-code](https://github.com/anthropics/claude-code) ⭐ 144,253 | 🐛 13,389 | 🌐 Python | 📅 2026-09-06 - Coding agent that understands your codebase, automates tasks, explains code, and manages git, all via natural language.

* [SwarmVault](https://github.com/swarmclawai/swarmvault) ⭐ 680 | 🐛 8 | 🌐 TypeScript | 📅 2026-06-30 - Local-first RAG knowledge vault with bundled MCP server (`npx -y @swarmvaultai/cli mcp`). Compiles raw sources (notes, transcripts, exports, docs, code) into a durable markdown wiki with a knowledge graph and hybrid SQLite FTS plus embeddings. Cuts agent token usage by serving compact wiki summaries instead of full file reads. MIT.

* [SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 664 | 🐛 18 | 🌐 TypeScript | 📅 2026-06-30 - Self-hosted multi-agent runtime that delegates to Claude Code, Codex, Gemini CLI, OpenCode, Copilot CLI, Cursor Agent, Goose, Qwen Code, and Droid. Org chart view, schedules, runtime skills, persistent memory, sub-agent spawning. MCP-native (server and client). Electron desktop app, CLI, and Docker. MIT.
...
* [agenttrace](https://github.com/luoyuctl/agenttrace) ⭐ 130 | 🐛 7 | 🌐 Rust | 📅 2026-09-06 - Local TUI for inspecting AI coding-agent session logs, usage, cost, latency, tool failures, diffs, and CI gates.
...
* [codex-profiles](https://github.com/Ducksss/codex-profiles) ⭐ 119 | 🐛 0 | 🌐 Shell | 📅 2026-09-04 - Small Bash helper for switching Codex CLI/Desktop accounts with isolated `CODEX_HOME` profiles.

* [ax](https://github.com/Necmttn/ax) ⭐ 105 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-06 - Local telemetry for AI coding agents.

* [nika](https://github.com/supernovae-st/nika) ⭐ 64 | 🐛 83 | 🌐 Rust | 📅 2026-09-06 - Workflow engine for AI: capture repeatable vibe-coded tasks as .nika.yaml files, statically checked before execution (schema, permits, cost), with tamper-evident traces after.
...
* [agent-qa](https://github.com/vostride/agent-qa) ⭐ 901 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - Self-improving QA agent for web and mobile apps. Write natural-language tests, retain run memory, and catch UI regressions before shipping.
...
* [liyupi/ai-guide](https://github.com/liyupi/ai-guide) ⭐ 19,597 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-02 - Free Chinese vibe coding handbook covering tool selection, prompting and context management, dozens of end-to-end project builds, and shipping to production. English and Traditional Chinese translations included. [Online version](https://ai.codefather.cn/vibe).

* [Vibe-Coding Prompt Template](https://github.com/KhazP/vibe-coding-prompt-template) ⭐ 3,043 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-05 - MIT-licensed five-step workflow (deep research, PRD, tech design, AGENTS.md, build) with copy-paste prompts and an `npx vibeworkflow` CLI that interviews you and writes the planning docs and agent files.
